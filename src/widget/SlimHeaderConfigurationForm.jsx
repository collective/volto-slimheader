...
const messages = defineMessages({
  ...
  visible: {
    id: 'slimheader-visible',
    defaultMessage: 'Visible',
  },
  inEvidence: {
    id: 'slimheader-inevidence',
    defaultMessage: 'In evidence',
  },
  linkUrl: {
    id: 'slimheader-linkUrl',
    defaultMessage: 'Link',
  },
  linkUrl_description: {
    id: 'slimheader-linkUrl_description',
    defaultMessage:
      'Type an external url, or select an internal url clicking on the right button',
  },
  deleteButton: {
    id: 'slimheader-deletemenuitem-button',
    defaultMessage: 'Delete menu item',
  },
});

const SlimHeaderConfigurationForm = ({
  id,
  menuItem,
  onChange,
  deleteMenuItem,
...
export default React.memo(
  compose(withObjectBrowser)(SlimHeaderConfigurationForm),
);
